...
export default registerAs('app', () => ({
  ...
  JWT_FORGOT_PASSWORD_TOKEN_ALGORITHM: process.env.JWT_FORGOT_PASSWORD_TOKEN_ALGORITHM,
  JWT_FORGOT_PASSWORD_TOKEN_EXPIRES_IN: process.env.JWT_FORGOT_PASSWORD_TOKEN_EXPIRES_IN,
  FORGOT_PASSWORD_LINK_EXPIRED: process.env.FORGOT_PASSWORD_LINK_EXPIRED,
